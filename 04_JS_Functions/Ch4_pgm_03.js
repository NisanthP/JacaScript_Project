...
// sale2 = { price: 40, taxRate: 10 };
// sale3 = { price: 120, taxRate: 20 };
// sale4 = { price: 980, taxRate: 2 }; // Corrected sale4
...
//   console.log("tax @ " + sale.taxRate + "% = $" + sale.tax.toFixed(2)); // Fixed the display to show two decimal places
